...
class Webhook {
    ...
    fun verify(
        ...
        var msgId = headers.firstValue(XWEBHOOK_MSG_ID_KEY)
        var msgSignature = headers.firstValue(XWEBHOOK_MSG_SIGNATURE_KEY)
        var msgTimestamp = headers.firstValue(XWEBHOOK_MSG_TIMESTAMP_KEY)
    ...
    companion object {
        ...
        const val XWEBHOOK_MSG_ID_KEY = "xwebhook-id"
        const val XWEBHOOK_MSG_SIGNATURE_KEY = "xwebhook-signature"
        const val XWEBHOOK_MSG_TIMESTAMP_KEY = "xwebhook-timestamp"
