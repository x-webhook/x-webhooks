...
from xwebhook.internal.openapi_client.models.aggregate_event_types_out import (
    AggregateEventTypesOut,
)
from xwebhook.internal.openapi_client.models.app_usage_stats_in import AppUsageStatsIn
from xwebhook.internal.openapi_client.models.app_usage_stats_out import AppUsageStatsOut
...
class ClientBase:
    ...
    def __init__(self, auth_token: str, options: XwebhookOptions = XwebhookOptions()) -> None:
        ...
        client = AuthenticatedClient(
            base_url=host,
            token=auth_token,
            headers={"user-agent": f"xwebhook-libs/{__version__}/python"},
            verify_ssl=True,
...
class XwebhookAsync(ClientBase):
    @property
