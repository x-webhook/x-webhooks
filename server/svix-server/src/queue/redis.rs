...
const MAIN: &str = "{queue}_xwebhook_v3_main";
...
const DELAYED: &str = "{queue}_xwebhook_delayed";

/// The key for the lock guarding the delayed queue background task.
const DELAYED_LOCK: &str = "{queue}_xwebhook_delayed_lock";

// v2 KEY CONSTANTS
const LEGACY_V2_MAIN: &str = "{queue}_xwebhook_main";
const LEGACY_V2_PROCESSING: &str = "{queue}_xwebhook_processing";

// v1 KEY CONSTANTS
const LEGACY_V1_MAIN: &str = "xwebhook_queue_main";
const LEGACY_V1_PROCESSING: &str = "xwebhook_queue_processing";
const LEGACY_V1_DELAYED: &str = "xwebhook_queue_delayed";
...
const WORKERS_GROUP: &str = "xwebhook_workers_group";
...
const WORKER_CONSUMER: &str = "xwebhook_workers_consumer";
...
pub mod tests {
    ...
    async fn test_migrate_list() {
        ...
        const TEST_QUEUE: &str = "{queue}_xwebhook_test_queue_list";
        const TEST_LEGACY: &str = "xwebhook_queue_test_list";
    ...
    async fn test_migrate_sset() {
        ...
        const TEST_QUEUE: &str = "{queue}_xwebhook_test_queue_sset";
        const TEST_LEGACY: &str = "xwebhook_queue_test_sset";
