...
type EnvironmentSettingsOut struct {
	...
	ShowUseXwebhookPlay *bool `json:"showUseXwebhookPlay,omitempty"`
}
...
func NewEnvironmentSettingsOut() *EnvironmentSettingsOut {
	...
	var showUseXwebhookPlay bool = true
...
// GetShowUseXwebhookPlay returns the ShowUseXwebhookPlay field value if set, zero value otherwise.
func (o *EnvironmentSettingsOut) GetShowUseXwebhookPlay() bool {
	if o == nil || o.ShowUseXwebhookPlay == nil {
		var ret bool
		return ret
	}
	return *o.ShowUseXwebhookPlay
}

// GetShowUseXwebhookPlayOk returns a tuple with the ShowUseXwebhookPlay field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *EnvironmentSettingsOut) GetShowUseXwebhookPlayOk() (*bool, bool) {
	if o == nil || o.ShowUseXwebhookPlay == nil {
		return nil, false
	}
	return o.ShowUseXwebhookPlay, true
}
...
// SetShowUseXwebhookPlay gets a reference to the given bool and assigns it to the ShowUseXwebhookPlay field.
func (o *EnvironmentSettingsOut) SetShowUseXwebhookPlay(v bool) {
	o.ShowUseXwebhookPlay = &v
}
...
func (o EnvironmentSettingsOut) MarshalJSON() ([]byte, error) {
	...
	if o.ShowUseXwebhookPlay != nil {
		toSerialize["showUseXwebhookPlay"] = o.ShowUseXwebhookPlay
	}
