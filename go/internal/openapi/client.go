...
// APIClient manages communication with the Xwebhook API API v1.1.1
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	...
	for try := 0; try < NumTries; try++ {
		...
		retryCount++
		request.Header.Set("xwebhook-retry-count", strconv.Itoa(retryCount))
...
func (c *APIClient) prepareRequest(
	...
	localVarRequest.Header.Add("xwebhook-req-id", strconv.FormatUint(rand.Uint64(), 10))
