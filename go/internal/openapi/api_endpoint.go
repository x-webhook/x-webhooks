 ...
 * @return EndpointOut
 */
func (a *EndpointApiService) V1EndpointCreateExecute(r ApiV1EndpointCreateRequest) (EndpointOut, *_nethttp.Response, error) {
	var (
...
func (r ApiV1EndpointDeleteRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1EndpointDeleteMtlsConfigRequest) Execute() (*_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointDeleteMtlsConfig(ctx _context.Context, appId string, endpointId string) ApiV1EndpointDeleteMtlsConfigRequest {
	return ApiV1EndpointDeleteMtlsConfigRequest{
		ApiService: a,
		ctx: ctx,
		appId: appId,
 ...
 * Execute executes the request
 */
func (a *EndpointApiService) V1EndpointDeleteMtlsConfigExecute(r ApiV1EndpointDeleteMtlsConfigRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @return EndpointOut
 */
func (a *EndpointApiService) V1EndpointGetExecute(r ApiV1EndpointGetRequest) (EndpointOut, *_nethttp.Response, error) {
	var (
...
func (r ApiV1EndpointGetHeadersRequest) Execute() (EndpointHeadersOut, *_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointGetHeadersExecute(r ApiV1EndpointGetHeadersRequest) (EndpointHeadersOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointGetSecretRequest) Execute() (EndpointSecretOut, *_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointGetSecretExecute(r ApiV1EndpointGetSecretRequest) (EndpointSecretOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointGetStatsRequest) Execute() (EndpointStats, *_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointGetStatsExecute(r ApiV1EndpointGetStatsRequest) (EndpointStats, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 */
func (a *EndpointApiService) V1EndpointListExecute(r ApiV1EndpointListRequest) (ListResponseEndpointOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointPatchHeadersRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1EndpointRecoverRequest) Execute() (RecoverOut, *_nethttp.Response, error) {
 ...
 * @return RecoverOut
 */
func (a *EndpointApiService) V1EndpointRecoverExecute(r ApiV1EndpointRecoverRequest) (RecoverOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointReplayRequest) Execute() (ReplayOut, *_nethttp.Response, error) {
 ...
 * @return ReplayOut
 */
func (a *EndpointApiService) V1EndpointReplayExecute(r ApiV1EndpointReplayRequest) (ReplayOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointRotateSecretRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1EndpointSendExampleRequest) Execute() (MessageOut, *_nethttp.Response, error) {
...
func (r ApiV1EndpointTransformationGetRequest) Execute() (EndpointTransformationOut, *_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointTransformationGetExecute(r ApiV1EndpointTransformationGetRequest) (EndpointTransformationOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointTransformationPartialUpdateRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1EndpointTransformationSimulateRequest) Execute() (EndpointTransformationSimulateOut, *_nethttp.Response, error) {
 ...
 */
func (a *EndpointApiService) V1EndpointTransformationSimulateExecute(r ApiV1EndpointTransformationSimulateRequest) (EndpointTransformationSimulateOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1EndpointUpdateRequest) Execute() (EndpointOut, *_nethttp.Response, error) {
 ...
 * @return EndpointOut
 */
func (a *EndpointApiService) V1EndpointUpdateExecute(r ApiV1EndpointUpdateRequest) (EndpointOut, *_nethttp.Response, error) {
	var (
...
func (r ApiV1EndpointUpdateHeadersRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1EndpointUpdateMtlsConfigRequest) Execute() (*_nethttp.Response, error) {
 ...
 * Execute executes the request
 */
func (a *EndpointApiService) V1EndpointUpdateMtlsConfigExecute(r ApiV1EndpointUpdateMtlsConfigRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
