...
func (r ApiV1IntegrationCreateRequest) Execute() (IntegrationOut, *_nethttp.Response, error) {
 ...
 */
func (a *IntegrationApiService) V1IntegrationCreateExecute(r ApiV1IntegrationCreateRequest) (IntegrationOut, *_nethttp.Response, error) {
	var (
...
func (r ApiV1IntegrationDeleteRequest) Execute() (*_nethttp.Response, error) {
...
func (r ApiV1IntegrationGetRequest) Execute() (IntegrationOut, *_nethttp.Response, error) {
 ...
 * @return IntegrationOut
 */
func (a *IntegrationApiService) V1IntegrationGetExecute(r ApiV1IntegrationGetRequest) (IntegrationOut, *_nethttp.Response, error) {
	var (
...
func (r ApiV1IntegrationGetKeyRequest) Execute() (IntegrationKeyOut, *_nethttp.Response, error) {
 ...
 */
func (a *IntegrationApiService) V1IntegrationGetKeyExecute(r ApiV1IntegrationGetKeyRequest) (IntegrationKeyOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1IntegrationListRequest) Execute() (ListResponseIntegrationOut, *_nethttp.Response, error) {
 ...
 */
func (a *IntegrationApiService) V1IntegrationListExecute(r ApiV1IntegrationListRequest) (ListResponseIntegrationOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1IntegrationRotateKeyRequest) Execute() (IntegrationKeyOut, *_nethttp.Response, error) {
 ...
 * @return IntegrationKeyOut
 */
func (a *IntegrationApiService) V1IntegrationRotateKeyExecute(r ApiV1IntegrationRotateKeyRequest) (IntegrationKeyOut, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiV1IntegrationUpdateRequest) Execute() (IntegrationOut, *_nethttp.Response, error) {
 ...
 * @return IntegrationOut
 */
func (a *IntegrationApiService) V1IntegrationUpdateExecute(r ApiV1IntegrationUpdateRequest) (IntegrationOut, *_nethttp.Response, error) {
	var (
