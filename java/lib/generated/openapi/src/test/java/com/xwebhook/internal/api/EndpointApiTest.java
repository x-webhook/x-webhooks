...
import com.xwebhook.models.EndpointMtlsConfigIn;
import com.xwebhook.models.EndpointOauthConfigIn;
...
import com.xwebhook.models.EndpointTransformationSimulateIn;
import com.xwebhook.models.EndpointTransformationSimulateOut;
...
import com.xwebhook.models.RecoverOut;
import com.xwebhook.models.ReplayIn;
import com.xwebhook.models.ReplayOut;
...
public class EndpointApiTest {
     ...
     * Get Endpoint Secret
     *
     * Get the endpoint&#39;s signing secret.  This is used to verify the authenticity of the webhook. For more information please refer to [the consuming webhooks docs](https://docs.xwebhook.com/consuming-webhooks/).
     *
     * @throws ApiException
     *          if the Api call fails
     */
