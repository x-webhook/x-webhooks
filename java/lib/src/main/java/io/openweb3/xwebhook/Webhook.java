...
public final class Webhook {
	...
	static final String XWEBHOOK_MSG_ID_KEY = "xwebhook-id";
	static final String XWEBHOOK_MSG_SIGNATURE_KEY = "xwebhook-signature";
	static final String XWEBHOOK_MSG_TIMESTAMP_KEY = "xwebhook-timestamp";
	...
	public void verify(final String payload, final HttpHeaders headers) throws WebhookVerificationException {
		Optional<String> msgId = headers.firstValue(XWEBHOOK_MSG_ID_KEY);
		Optional<String> msgSignature = headers.firstValue(XWEBHOOK_MSG_SIGNATURE_KEY);
		Optional<String> msgTimestamp = headers.firstValue(XWEBHOOK_MSG_TIMESTAMP_KEY);
