...
import io.openweb3.xwebhook.internal.auth.Authentication;
import io.openweb3.xwebhook.internal.auth.HttpBasicAuth;
import io.openweb3.xwebhook.internal.auth.HttpBearerAuth;
import io.openweb3.xwebhook.internal.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "https://api.webhook.openweb3.io";
    ...
    private void init() {
        ...
        addDefaultHeader("xwebhook-req-id", String.valueOf(Math.abs(randomId)));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.webhook.openweb3.io
    ...
    public <T> ApiResponse<T> execute(Call call, Type returnType) throws ApiException {
        ...
        for (int retry = 0; retry < numRetries; retry++) {
            ...
            retryCount++;
            call = httpClient.newCall(call.request().newBuilder().header("xwebhook-retry-count", String.valueOf(retryCount)).build());
