...
namespace Xwebhook
{
    public sealed class Webhook
    {
        ...
        {
            string msgId = headers.Get(XWEBHOOK_ID_HEADER_KEY);
            string msgSignature = headers.Get(XWEBHOOK_SIGNATURE_HEADER_KEY);
            string msgTimestamp = headers.Get(XWEBHOOK_TIMESTAMP_HEADER_KEY);
