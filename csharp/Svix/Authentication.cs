...
namespace Xwebhook
{
    public sealed class Authentication : XwebhookResourceBase, IAuthentication
    {
        private readonly IAuthenticationApi _authenticationApi;

        public Authentication(IXwebhookClient xwebhookClient, IAuthenticationApi authenticationApi)
            : base(xwebhookClient)
        {
