...
namespace Xwebhook
{
    public sealed class Integration : XwebhookResourceBase, IIntegration
    {
        private readonly IIntegrationApi _integrationApi;

        public Integration(IXwebhookClient xwebhookClient, IIntegrationApi integrationApi) : base(xwebhookClient)
        {
