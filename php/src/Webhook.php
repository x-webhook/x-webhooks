...
class Webhook
{
    ...
    {
        if (
            isset($headers['xwebhook-id'])
            && isset($headers['xwebhook-timestamp'])
            && isset($headers['xwebhook-signature'])
        ) {
            $msgId = $headers['xwebhook-id'];
            $msgTimestamp = $headers['xwebhook-timestamp'];
            $msgSignature = $headers['xwebhook-signature'];
        } elseif (
